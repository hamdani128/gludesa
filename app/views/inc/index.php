...
<!-- Mirrored from makaanlelo.com/tfdl_products_007/dompet/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Aug 2022 09:32:33 GMT -->
...
<head>
    ...
    <link href="<?= URLROOT ?>/assets/vendor/jquery-nice-select/css/nice-select.css" rel="stylesheet">
    <link rel="stylesheet" href="<?= URLROOT ?>/assets/vendor/nouislider/nouislider.min.css">
    <!-- Style css -->
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="<?php echo URLROOT ?>/home" class="brand-logo">
