...
<div class="content-body">
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Data Layanan Surat / Arsip Layanan Surat </a>
                </li>
            </ol>
        </div>
        <!-- content -->
            ...
            <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="card bg-primary invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">22</h2>
                            <span class="text-white fs-18">Permohonan</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card bg-success invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            ...
                            <span class="text-white fs-18">Arsip</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card bg-danger invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            ...
                            <span class="text-white fs-18">Ditolak</span>
                        </div>
                    </div>
                </div>
            </div>
