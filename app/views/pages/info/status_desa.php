                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <select class="form-control" name="idm" id="idm">
                                        <option value="">Pilih IDM</option>
                                    </select>
                                    ...
                                    <div class="col-xl-6 col-xxl-6 col-sm-6">
                                        <div class="card bg-warning invoice-card">
                                            <div class="card-body d-flex">
                                                ...
                                                <div>
                                                    <h2 class="text-white invoice-num">0.6711</h2>
                                                    <span class="text-white fs-18">SKOR IDM Saat ini</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-xxl-6 col-sm-6">
                                        <div class="card bg-success invoice-card">
                                            <div class="card-body d-flex">
                                                ...
                                                <div>
                                                    <h2 class="text-white invoice-num">0.7073</h2>
                                                    <span class="text-white fs-18">SKOR IDM Minimal</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-xxl-6 col-sm-6">
                                        <div class="card bg-info invoice-card">
                                            <div class="card-body d-flex">
                                                ...
                                                <div>
                                                    <h2 class="text-white invoice-num">BERKEMBANG</h2>
                                                    <span class="text-white fs-18">Status IDM</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-xxl-6 col-sm-6">
                                        <div class="card bg-secondary invoice-card">
                                            <div class="card-body d-flex">
                                                ...
                                                <div>
                                                    <h2 class="text-white invoice-num">MAJU</h2>
                                                    <span class="text-white fs-18">Target Status</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
